...
public class AADMDomainModelFactory {
    ...
    public AxPolicyModel getAADMPolicyModel() {
        ...
        final AxContextSchema ueIPAddress = new AxContextSchema(new AxArtifactKey("UEIPAddress", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema nwIPAddress = new AxContextSchema(new AxArtifactKey("NWIPAddress", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema dosFlag = new AxContextSchema(new AxArtifactKey("DOSFlag", "0.0.1"), "Java", "java.lang.Boolean");
        final AxContextSchema roundTripTime = new AxContextSchema(new AxArtifactKey("RoundTripTime", "0.0.1"), "Java", "java.lang.Long");
        final AxContextSchema applicationName = new AxContextSchema(new AxArtifactKey("ApplicationName", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema protocolGroup = new AxContextSchema(new AxArtifactKey("ProtocolGroup", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema eNodeBID = new AxContextSchema(new AxArtifactKey("ENodeBID", "0.0.1"), "Java", "java.lang.Long");
        final AxContextSchema httpHostClass = new AxContextSchema(new AxArtifactKey("HttpHostClass", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema tcpOnFlag = new AxContextSchema(new AxArtifactKey("TCPOnFlag", "0.0.1"), "Java", "java.lang.Boolean");
        final AxContextSchema probeOnFlag = new AxContextSchema(new AxArtifactKey("ProbeOnFlag", "0.0.1"), "Java", "java.lang.Boolean");
        final AxContextSchema blacklistOnFlag = new AxContextSchema(new AxArtifactKey("BlacklistOnFlag", "0.0.1"), "Java", "java.lang.Boolean");
        final AxContextSchema averageThroughput = new AxContextSchema(new AxArtifactKey("AverageThroughput", "0.0.1"), "Java", "java.lang.Double");
        final AxContextSchema serviceRequestCount = new AxContextSchema(new AxArtifactKey("ServiceRequestCount", "0.0.1"), "Java", "java.lang.Integer");
        final AxContextSchema attchCount = new AxContextSchema(new AxArtifactKey("AttachCount", "0.0.1"), "Java", "java.lang.Integer");
        final AxContextSchema subscriberCount = new AxContextSchema(new AxArtifactKey("SubscriberCount", "0.0.1"), "Java", "java.lang.Integer");
        final AxContextSchema averageServiceRequest = new AxContextSchema(new AxArtifactKey("AverageServiceRequest", "0.0.1"), "Java", "java.lang.Double");
        final AxContextSchema averageAttach = new AxContextSchema(new AxArtifactKey("AverageAttach", "0.0.1"), "Java", "java.lang.Double");
        final AxContextSchema actionTask = new AxContextSchema(new AxArtifactKey("ActionTask", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema version = new AxContextSchema(new AxArtifactKey("Version", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema profile = new AxContextSchema(new AxArtifactKey("Profile", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema threshold = new AxContextSchema(new AxArtifactKey("Threshold", "0.0.1"), "Java", "java.lang.Long");
        final AxContextSchema triggerSpec = new AxContextSchema(new AxArtifactKey("TriggerSpec", "0.0.1"), "Java", "java.lang.String");
        final AxContextSchema periodicEventCount = new AxContextSchema(new AxArtifactKey("PeriodicEventCount", "0.0.1"), "Java", "java.lang.Long");
        ...
        final AxEvent aadmEvent = new AxEvent(new AxArtifactKey("AADMEvent", "0.0.1"), "com.ericsson.apex.domains.aadm.events");
        aadmEvent.setSource("External");
        aadmEvent.setTarget("Apex");
        aadmEvent.getParameterMap().put("IMSI", new AxField(new AxReferenceKey(aadmEvent.getKey(), "IMSI"), imsi.getKey()));
        aadmEvent.getParameterMap().put("ENODEB_ID", new AxField(new AxReferenceKey(aadmEvent.getKey(), "ENODEB_ID"), eNodeBID.getKey()));
        aadmEvent.getParameterMap().put("IMSI_IP", new AxField(new AxReferenceKey(aadmEvent.getKey(), "IMSI_IP"), ueIPAddress.getKey()));
        aadmEvent.getParameterMap().put("NW_IP", new AxField(new AxReferenceKey(aadmEvent.getKey(), "NW_IP"), nwIPAddress.getKey()));
        aadmEvent.getParameterMap().put("DoS", new AxField(new AxReferenceKey(aadmEvent.getKey(), "DoS"), dosFlag.getKey()));
        aadmEvent.getParameterMap().put("TCP_UE_SIDE_MEDIAN_RTT_TX_TO_RX",
                new AxField(new AxReferenceKey(aadmEvent.getKey(), "TCP_UE_SIDE_MEDIAN_RTT_TX_TO_RX"), roundTripTime.getKey()));
        aadmEvent.getParameterMap().put("TCP_UE_SIDE_AVG_THROUGHPUT",
                new AxField(new AxReferenceKey(aadmEvent.getKey(), "TCP_UE_SIDE_AVG_THROUGHPUT"), averageThroughput.getKey()));
        aadmEvent.getParameterMap().put("APPLICATION", new AxField(new AxReferenceKey(aadmEvent.getKey(), "APPLICATION"), applicationName.getKey()));
        aadmEvent.getParameterMap().put("protocol_group", new AxField(new AxReferenceKey(aadmEvent.getKey(), "protocol_group"), protocolGroup.getKey()));
        aadmEvent.getParameterMap().put("http_host_class", new AxField(new AxReferenceKey(aadmEvent.getKey(), "http_host_class"), httpHostClass.getKey()));
        aadmEvent.getParameterMap().put("PROBE_ON", new AxField(new AxReferenceKey(aadmEvent.getKey(), "PROBE_ON"), probeOnFlag.getKey()));
        aadmEvent.getParameterMap().put("TCP_ON", new AxField(new AxReferenceKey(aadmEvent.getKey(), "TCP_ON"), tcpOnFlag.getKey()));
        aadmEvent.getParameterMap().put("SGW_IP_ADDRESS", new AxField(new AxReferenceKey(aadmEvent.getKey(), "SGW_IP_ADDRESS"), nwIPAddress.getKey()));
        aadmEvent.getParameterMap().put("UE_IP_ADDRESS", new AxField(new AxReferenceKey(aadmEvent.getKey(), "UE_IP_ADDRESS"), ueIPAddress.getKey()));
        aadmEvent.getParameterMap().put("SERVICE_REQUEST_COUNT",
                new AxField(new AxReferenceKey(aadmEvent.getKey(), "SERVICE_REQUEST_COUNT"), serviceRequestCount.getKey()));
        aadmEvent.getParameterMap().put("ATTACH_COUNT", new AxField(new AxReferenceKey(aadmEvent.getKey(), "ATTACH_COUNT"), attchCount.getKey()));
        aadmEvent.getParameterMap().put("NUM_SUBSCRIBERS", new AxField(new AxReferenceKey(aadmEvent.getKey(), "NUM_SUBSCRIBERS"), subscriberCount.getKey()));
        aadmEvent.getParameterMap().put("AVG_SUBSCRIBER_SERVICE_REQUEST",
                new AxField(new AxReferenceKey(aadmEvent.getKey(), "AVG_SUBSCRIBER_SERVICE_REQUEST"), averageServiceRequest.getKey()));
        ...
        aadmEvent.getParameterMap().put("ACTTASK", new AxField(new AxReferenceKey(aadmEvent.getKey(), "ACTTASK"), actionTask.getKey()));

        final AxEvent aadmXStreamActEvent = new AxEvent(new AxArtifactKey("XSTREAM_AADM_ACT_EVENT", "0.0.1"), "com.ericsson.apex.domains.aadm.events");
        aadmXStreamActEvent.setSource("Apex");
        aadmXStreamActEvent.setTarget("External");
        aadmXStreamActEvent.getParameterMap().put("IMSI", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "IMSI"), imsi.getKey()));
        aadmXStreamActEvent.getParameterMap().put("IMSI_IP", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "IMSI_IP"), ueIPAddress.getKey()));
        aadmXStreamActEvent.getParameterMap().put("ENODEB_ID", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "ENODEB_ID"), eNodeBID.getKey()));
        aadmXStreamActEvent.getParameterMap().put("NW_IP", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "NW_IP"), nwIPAddress.getKey()));
        aadmXStreamActEvent.getParameterMap().put("ACTTASK", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "ACTTASK"), actionTask.getKey()));
        aadmXStreamActEvent.getParameterMap().put("PROBE_ON", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "PROBE_ON"), probeOnFlag.getKey()));
        aadmXStreamActEvent.getParameterMap().put("TCP_ON", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "TCP_ON"), tcpOnFlag.getKey()));
        aadmXStreamActEvent.getParameterMap().put("VERSION", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "VERSION"), version.getKey()));
        ...
        aadmXStreamActEvent.getParameterMap().put("MAJ_MIN_MAINT_VERSION",
                new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "MAJ_MIN_MAINT_VERSION"), version.getKey()));
        aadmXStreamActEvent.getParameterMap().put("BLACKLIST_ON",
                new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "BLACKLIST_ON"), blacklistOnFlag.getKey()));
        aadmXStreamActEvent.getParameterMap().put("PROFILE", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "PROFILE"), profile.getKey()));
        aadmXStreamActEvent.getParameterMap().put("THRESHOLD", new AxField(new AxReferenceKey(aadmXStreamActEvent.getKey(), "THRESHOLD"), threshold.getKey()));

        final AxEvent vMMEEvent = new AxEvent(new AxArtifactKey("VMMEEvent", "0.0.1"), "com.ericsson.apex.domains.aadm.events");
        vMMEEvent.setSource("External");
        vMMEEvent.setTarget("Apex");
        vMMEEvent.getParameterMap().put("IMSI", new AxField(new AxReferenceKey(vMMEEvent.getKey(), "IMSI"), imsi.getKey()));
        vMMEEvent.getParameterMap().put("ENODEB_ID", new AxField(new AxReferenceKey(vMMEEvent.getKey(), "ENODEB_ID"), eNodeBID.getKey()));
        vMMEEvent.getParameterMap().put("IMSI_IP", new AxField(new AxReferenceKey(vMMEEvent.getKey(), "IMSI_IP"), ueIPAddress.getKey()));
        vMMEEvent.getParameterMap().put("NW_IP", new AxField(new AxReferenceKey(vMMEEvent.getKey(), "NW_IP"), nwIPAddress.getKey()));
        vMMEEvent.getParameterMap().put("PROFILE", new AxField(new AxReferenceKey(vMMEEvent.getKey(), "PROFILE"), profile.getKey()));
        vMMEEvent.getParameterMap().put("THRESHOLD", new AxField(new AxReferenceKey(vMMEEvent.getKey(), "THRESHOLD"), threshold.getKey()));

        final AxEvent sapcEvent = new AxEvent(new AxArtifactKey("SAPCEvent", "0.0.1"), "com.ericsson.apex.domains.aadm.events");
        sapcEvent.setSource("External");
        sapcEvent.setTarget("Apex");
        sapcEvent.getParameterMap().put("IMSI", new AxField(new AxReferenceKey(sapcEvent.getKey(), "IMSI"), imsi.getKey()));
        sapcEvent.getParameterMap().put("ENODEB_ID", new AxField(new AxReferenceKey(sapcEvent.getKey(), "ENODEB_ID"), eNodeBID.getKey()));
        sapcEvent.getParameterMap().put("IMSI_IP", new AxField(new AxReferenceKey(sapcEvent.getKey(), "IMSI_IP"), ueIPAddress.getKey()));
        sapcEvent.getParameterMap().put("NW_IP", new AxField(new AxReferenceKey(sapcEvent.getKey(), "NW_IP"), nwIPAddress.getKey()));
        sapcEvent.getParameterMap().put("PROFILE", new AxField(new AxReferenceKey(sapcEvent.getKey(), "PROFILE"), profile.getKey()));
        sapcEvent.getParameterMap().put("THRESHOLD", new AxField(new AxReferenceKey(sapcEvent.getKey(), "THRESHOLD"), threshold.getKey()));
        sapcEvent.getParameterMap().put("TCP_ON", new AxField(new AxReferenceKey(sapcEvent.getKey(), "TCP_ON"), tcpOnFlag.getKey()));
        sapcEvent.getParameterMap().put("PROBE_ON", new AxField(new AxReferenceKey(sapcEvent.getKey(), "PROBE_ON"), probeOnFlag.getKey()));
        sapcEvent.getParameterMap().put("VERSION", new AxField(new AxReferenceKey(sapcEvent.getKey(), "VERSION"), version.getKey()));
        sapcEvent.getParameterMap().put("BLACKLIST_ON", new AxField(new AxReferenceKey(sapcEvent.getKey(), "BLACKLIST_ON"), blacklistOnFlag.getKey()));

        final AxEvent sapcBlacklistSubscriberEvent = new AxEvent(new AxArtifactKey("SAPCBlacklistSubscriberEvent", "0.0.1"),
                "com.ericsson.apex.domains.aadm.events");
        ...
        sapcBlacklistSubscriberEvent.getParameterMap().put("BLACKLIST_ON",
                new AxField(new AxReferenceKey(sapcBlacklistSubscriberEvent.getKey(), "BLACKLIST_ON"), blacklistOnFlag.getKey()));
        sapcBlacklistSubscriberEvent.getParameterMap().put("IMSI_IP",
                new AxField(new AxReferenceKey(sapcBlacklistSubscriberEvent.getKey(), "IMSI_IP"), ueIPAddress.getKey()));
        ...
        sapcBlacklistSubscriberEvent.getParameterMap().put("PROBE_ON",
                new AxField(new AxReferenceKey(sapcBlacklistSubscriberEvent.getKey(), "PROBE_ON"), probeOnFlag.getKey()));
        ...
        final AxEvent periodicEvent = new AxEvent(new AxArtifactKey("PeriodicEvent", "0.0.1"), "com.ericsson.apex.domains.aadm.events");
        periodicEvent.setSource("System");
        periodicEvent.setTarget("Apex");
        periodicEvent.getParameterMap().put("PERIODIC_EVENT_COUNT",
                new AxField(new AxReferenceKey(periodicEvent.getKey(), "PERIODIC_EVENT_COUNT"), periodicEventCount.getKey()));
        ...
        periodicEvent.getParameterMap().put("PERIODIC_CURRENT_TIME",
                new AxField(new AxReferenceKey(periodicEvent.getKey(), "PERIODIC_CURRENT_TIME"), periodicTime.getKey()));
        ...
        final AxContextSchema eNodeBStatus = new AxContextSchema(new AxArtifactKey("ENodeBStatus", "0.0.1"), "Java",
                "com.ericsson.apex.domains.aadm.concepts.ENodeBStatus");
        final AxContextSchema imsiStatus = new AxContextSchema(new AxArtifactKey("IMSIStatus", "0.0.1"), "Java",
                "com.ericsson.apex.domains.aadm.concepts.IMSIStatus");
        final AxContextSchema ipAddressStatus = new AxContextSchema(new AxArtifactKey("IPAddressStatus", "0.0.1"), "Java",
                "com.ericsson.apex.domains.aadm.concepts.IPAddressStatus");
        ...
        final AxContextAlbum eNodeBStatusAlbum = new AxContextAlbum(new AxArtifactKey("ENodeBStatusAlbum", "0.0.1"), "APPLICATION", true,
                eNodeBStatus.getKey());
        final AxContextAlbum imsiStatusAlbum = new AxContextAlbum(new AxArtifactKey("IMSIStatusAlbum", "0.0.1"), "APPLICATION", true, imsiStatus.getKey());
        final AxContextAlbum ipAddressStatusAlbum = new AxContextAlbum(new AxArtifactKey("IPAddressStatusAlbum", "0.0.1"), "APPLICATION", true,
        ...
        // Tasks
        final AxLogicReader logicReader = new PolicyLogicReader().setLogicPackage(this.getClass().getPackage().getName()).setDefaultLogic(null);
        ...
        aadmDoSSuggestionActTask.setTaskLogic(new AxTaskLogic(aadmDoSSuggestionActTask.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        aadmDoSProvenActTask.setTaskLogic(new AxTaskLogic(aadmDoSProvenActTask.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        periodicEstablishTask.setTaskLogic(new AxTaskLogic(periodicEstablishTask.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        final AxStateOutput aadmAct2Out = new AxStateOutput(aadmActState.getKey(), AxReferenceKey.getNullKey(), aadmXStreamActEvent.getKey());
        ...
        aadmActState.setTaskSelectionLogic(new AxTaskSelectionLogic(aadmActState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        aadmActState.setDefaultTask(aadmNoActTask.getKey());
        aadmActState.getTaskReferences().put(aadmNoActTask.getKey(),
                new AxStateTaskReference(aadmActState.getKey(), aadmNoActTask.getKey(), AxStateTaskOutputType.DIRECT, aadmAct2Out.getKey()));
        aadmActState.getTaskReferences().put(aadmDoSSuggestionActTask.getKey(),
                new AxStateTaskReference(aadmActState.getKey(), aadmDoSSuggestionActTask.getKey(), AxStateTaskOutputType.DIRECT, aadmAct2Out.getKey()));
        aadmActState.getTaskReferences().put(aadmDoSProvenActTask.getKey(),
                new AxStateTaskReference(aadmActState.getKey(), aadmDoSProvenActTask.getKey(), AxStateTaskOutputType.DIRECT, aadmAct2Out.getKey()));
        ...
        final AxStateOutput aadmDec2Act = new AxStateOutput(aadmDecideState.getKey(), aadmActState.getKey(), aadmEvent.getKey());
        aadmDecideState.getStateOutputs().put(aadmDec2Act.getKey().getLocalName(), aadmDec2Act);
        aadmDecideState.setTaskSelectionLogic(new AxTaskSelectionLogic(aadmDecideState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        aadmDecideState.setDefaultTask(aadmDecideTask.getKey());
        aadmDecideState.getTaskReferences().put(aadmDecideTask.getKey(),
                new AxStateTaskReference(aadmDecideState.getKey(), aadmDecideTask.getKey(), AxStateTaskOutputType.DIRECT, aadmDec2Act.getKey()));
        ...
        final AxStateOutput aadmEst2Dec = new AxStateOutput(aadmEstablishState.getKey(), aadmDecideState.getKey(), aadmEvent.getKey());
        aadmEstablishState.getStateOutputs().put(aadmEst2Dec.getKey().getLocalName(), aadmEst2Dec);
        aadmEstablishState.setTaskSelectionLogic(new AxTaskSelectionLogic(aadmEstablishState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        ...
        aadmEstablishState.getTaskReferences().put(aadmEstablishTask.getKey(),
                new AxStateTaskReference(aadmEstablishState.getKey(), aadmEstablishTask.getKey(), AxStateTaskOutputType.DIRECT, aadmEst2Dec.getKey()));
        ...
        final AxStateOutput aadmMat2Est = new AxStateOutput(aadmMatchState.getKey(), aadmEstablishState.getKey(), aadmEvent.getKey());
        aadmMatchState.getStateOutputs().put(aadmMat2Est.getKey().getLocalName(), aadmMat2Est);
        aadmMatchState.setTaskSelectionLogic(new AxTaskSelectionLogic(aadmMatchState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        aadmMatchState.setDefaultTask(aadmMatchTask.getKey());
        aadmMatchState.getTaskReferences().put(aadmMatchTask.getKey(),
                new AxStateTaskReference(aadmMatchState.getKey(), aadmMatchTask.getKey(), AxStateTaskOutputType.DIRECT, aadmMat2Est.getKey()));
        ...
        final AxStateOutput vMMEAct2Out = new AxStateOutput(vMMEActState.getKey(), AxReferenceKey.getNullKey(), vMMEEvent.getKey());
        ...
        vMMEActState.getTaskReferences().put(vMMEActTask.getKey(),
                new AxStateTaskReference(vMMEActState.getKey(), vMMEActTask.getKey(), AxStateTaskOutputType.DIRECT, vMMEAct2Out.getKey()));
        vMMEActState.getTaskReferences().put(vMMENoActTask.getKey(),
                new AxStateTaskReference(vMMEActState.getKey(), vMMENoActTask.getKey(), AxStateTaskOutputType.DIRECT, vMMEAct2Out.getKey()));
        ...
        final AxStateOutput vMMEDec2Act = new AxStateOutput(vMMEDecideState.getKey(), vMMEActState.getKey(), vMMEEvent.getKey());
        ...
        vMMEDecideState.getTaskReferences().put(vMMEDecideTask.getKey(),
                new AxStateTaskReference(vMMEDecideState.getKey(), vMMEDecideTask.getKey(), AxStateTaskOutputType.DIRECT, vMMEDec2Act.getKey()));
        ...
        final AxStateOutput vMMEEst2Dec = new AxStateOutput(vMMEEstablishState.getKey(), vMMEDecideState.getKey(), vMMEEvent.getKey());
        ...
        vMMEEstablishState.getTaskReferences().put(vMMEEstablishTask.getKey(),
                new AxStateTaskReference(vMMEEstablishState.getKey(), vMMEEstablishTask.getKey(), AxStateTaskOutputType.DIRECT, vMMEEst2Dec.getKey()));
        ...
        final AxStateOutput vMMEMat2Est = new AxStateOutput(vMMEMatchState.getKey(), vMMEEstablishState.getKey(), vMMEEvent.getKey());
        ...
        vMMEMatchState.getTaskReferences().put(vMMEMatchTask.getKey(),
                new AxStateTaskReference(vMMEMatchState.getKey(), vMMEMatchTask.getKey(), AxStateTaskOutputType.DIRECT, vMMEMat2Est.getKey()));
        ...
        final AxStateOutput sapcAct2Out = new AxStateOutput(sapcActState.getKey(), AxReferenceKey.getNullKey(), sapcBlacklistSubscriberEvent.getKey());
        ...
        sapcActState.getTaskReferences().put(sapcActTask.getKey(),
                new AxStateTaskReference(sapcActState.getKey(), sapcActTask.getKey(), AxStateTaskOutputType.DIRECT, sapcAct2Out.getKey()));
        ...
        sapcDecideState.getTaskReferences().put(sapcDecideTask.getKey(),
                new AxStateTaskReference(sapcDecideState.getKey(), sapcDecideTask.getKey(), AxStateTaskOutputType.DIRECT, sapcDec2Act.getKey()));
        ...
        sapcEstablishState.getTaskReferences().put(sapcEstablishTask.getKey(),
                new AxStateTaskReference(sapcEstablishState.getKey(), sapcEstablishTask.getKey(), AxStateTaskOutputType.DIRECT, sapcEst2Dec.getKey()));
        ...
        final AxStateOutput sapcMat2Est = new AxStateOutput(sapcMatchState.getKey(), sapcEstablishState.getKey(), sapcEvent.getKey());
        ...
        sapcMatchState.getTaskReferences().put(sapcMatchTask.getKey(),
                new AxStateTaskReference(sapcMatchState.getKey(), sapcMatchTask.getKey(), AxStateTaskOutputType.DIRECT, sapcMat2Est.getKey()));
        ...
        final AxStateOutput perAct2Out = new AxStateOutput(periodicActState.getKey(), AxReferenceKey.getNullKey(), sapcBlacklistSubscriberEvent.getKey());
        ...
        periodicActState.getTaskReferences().put(periodicActTask.getKey(),
                new AxStateTaskReference(periodicActState.getKey(), periodicActTask.getKey(), AxStateTaskOutputType.DIRECT, perAct2Out.getKey()));
        ...
        final AxStateOutput perDec2Act = new AxStateOutput(periodicDecideState.getKey(), periodicActState.getKey(), periodicEvent.getKey());
        ...
        periodicDecideState.getTaskReferences().put(periodicDecideTask.getKey(),
                new AxStateTaskReference(periodicDecideState.getKey(), periodicDecideTask.getKey(), AxStateTaskOutputType.DIRECT, perDec2Act.getKey()));
        ...
        final AxStateOutput perEst2Dec = new AxStateOutput(periodicEstablishState.getKey(), periodicDecideState.getKey(), periodicEvent.getKey());
        ...
        periodicEstablishState.getTaskReferences().put(periodicEstablishTask.getKey(),
                new AxStateTaskReference(periodicEstablishState.getKey(), periodicEstablishTask.getKey(), AxStateTaskOutputType.DIRECT, perEst2Dec.getKey()));
        ...
        final AxStateOutput perMat2Est = new AxStateOutput(periodicMatchState.getKey(), periodicEstablishState.getKey(), periodicEvent.getKey());
