...
package com.ericsson.apex.domains.vpn.java.model;
...
/**
 * The Class VPNDomainModelFactory.
 */
public class VPNDomainModelFactory {
    ...
    public AxPolicyModel getVPNPolicyModel() {
        ...
        final AxContextSchema affectedCustomers = new AxContextSchema(new AxArtifactKey("AffectedCustomers", "0.0.1"), "Java",
                "com.ericsson.apex.domains.vpn.java.concepts.VPNCustomerArray");
        ...
        final AxContextSchema linkMap = new AxContextSchema(new AxArtifactKey("LinkMap", "0.0.1"), "Java",
                "com.ericsson.apex.domains.vpn.java.concepts.VPNLinkMap");
        final AxContextSchema customerMap = new AxContextSchema(new AxArtifactKey("CustomerMap", "0.0.1"), "Java",
                "com.ericsson.apex.domains.vpn.java.concepts.VPNCustomerMap");
        ...
        final AxContextSchema vpnCustomer = new AxContextSchema(new AxArtifactKey("VPNCustomer", "0.0.1"), "Java",
                "com.ericsson.apex.domains.vpn.java.concepts.VPNCustomer");
        final AxContextSchema vpnLink = new AxContextSchema(new AxArtifactKey("VPNLink", "0.0.1"), "Java",
                "com.ericsson.apex.domains.vpn.java.concepts.VPNLink");
        final AxContextSchema vpnProblem = new AxContextSchema(new AxArtifactKey("VPNProblem", "0.0.1"), "Java",
                "com.ericsson.apex.domains.vpn.java.concepts.VPNProblem");
        ...
        final AxPolicyModel vpnPolicyModel = new AxPolicyModel(new AxArtifactKey("VPNPolicyModelJava", "0.0.1"));
