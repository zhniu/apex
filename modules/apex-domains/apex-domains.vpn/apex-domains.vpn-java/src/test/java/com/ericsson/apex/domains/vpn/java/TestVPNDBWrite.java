...
public class TestVPNDBWrite {
	...
	public void setup() throws Exception {
		...
		testApexModel = new TestApexModel<AxPolicyModel>(AxPolicyModel.class, new TestVPNModelCreator());
	}
	...
	public void testModelWriteReadJPA() throws Exception {
		...
		daoParameters.setPersistenceUnit("VPNModelTest");
