...
public class AdaptiveDomainModelFactory {
    ...
    public AxPolicyModel getAnomalyDetectionPolicyModel() {
        ...
        final AxContextSchema monitoredValue = new AxContextSchema(new AxArtifactKey("MonitoredValue", "0.0.1"), "Java", "java.lang.Double");
        final AxContextSchema iteration = new AxContextSchema(new AxArtifactKey("Iteration", "0.0.1"), "Java", "java.lang.Integer");
        ...
        final AxEvent anomalyDetectionTriggerEvent = new AxEvent(new AxArtifactKey("AnomalyDetectionTriggerEvent", "0.0.1"),
                "com.ericsson.apex.domains.adaptive.events");
        anomalyDetectionTriggerEvent.setSource("External");
        anomalyDetectionTriggerEvent.setTarget("Match");
        anomalyDetectionTriggerEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(anomalyDetectionTriggerEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        anomalyDetectionTriggerEvent.getParameterMap().put("Iteration",
                new AxField(new AxReferenceKey(anomalyDetectionTriggerEvent.getKey(), "Iteration"), iteration.getKey()));
        ...
        anomalyDetectionMatchEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(anomalyDetectionMatchEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        ...
        final AxEvent anomalyDetectionEstablishEvent = new AxEvent(new AxArtifactKey("AnomalyDetectionEstablishEvent", "0.0.1"),
                "com.ericsson.apex.domains.adaptive.events");
        ...
        anomalyDetectionEstablishEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(anomalyDetectionEstablishEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        anomalyDetectionEstablishEvent.getParameterMap().put("Iteration",
                new AxField(new AxReferenceKey(anomalyDetectionEstablishEvent.getKey(), "Iteration"), iteration.getKey()));

        final AxEvent anomalyDetectionDecideEvent = new AxEvent(new AxArtifactKey("AnomalyDetectionDecideEvent", "0.0.1"),
                "com.ericsson.apex.domains.adaptive.events");
        anomalyDetectionDecideEvent.setSource("Decide");
        anomalyDetectionDecideEvent.setTarget("Act");
        anomalyDetectionDecideEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(anomalyDetectionDecideEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        ...
        anomalyDetectionActEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(anomalyDetectionActEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        ...
        anomalyDetectionEvents.getEventMap().put(anomalyDetectionEstablishEvent.getKey(), anomalyDetectionEstablishEvent);
        ...
        final AxContextSchema anomalyDetection = new AxContextSchema(new AxArtifactKey("AnomalyDetection", "0.0.1"), "Java",
                "com.ericsson.apex.domains.adaptive.concepts.AnomalyDetection");
        adContextSchemas.getSchemasMap().put(anomalyDetection.getKey(), anomalyDetection);

        // One context map
        final AxContextAlbum anomalyDetectionAlbum = new AxContextAlbum(new AxArtifactKey("AnomalyDetectionAlbum", "0.0.1"), "APPLICATION", true,
                anomalyDetection.getKey());
        final AxContextAlbums anomalyDetectionAlbums = new AxContextAlbums(new AxArtifactKey("AnomalyDetectionAlbums", "0.0.1"));
        anomalyDetectionAlbums.getAlbumsMap().put(anomalyDetectionAlbum.getKey(), anomalyDetectionAlbum);

        // Tasks
        final AxLogicReader logicReader = new PolicyLogicReader().setLogicPackage(this.getClass().getPackage().getName())
        ...
        anomalyDetectionMatchTask.setTaskLogic(new AxTaskLogic(anomalyDetectionMatchTask.getKey(), "TaskLogic", "MVEL", logicReader));

        final AxTask anomalyDetectionEstablishTask = new AxTask(new AxArtifactKey("AnomalyDetectionEstablishTask", "0.0.1"));
        ...
        anomalyDetectionEstablishTask.setTaskLogic(new AxTaskLogic(anomalyDetectionEstablishTask.getKey(), "TaskLogic", "MVEL", logicReader));

        final AxTask anomalyDetectionDecideTask0 = new AxTask(new AxArtifactKey("AnomalyDetectionDecideTask0", "0.0.1"));
        ...
        anomalyDetectionDecideTask0.setTaskLogic(new AxTaskLogic(anomalyDetectionDecideTask0.getKey(), "TaskLogic", "MVEL", logicReader));

        final AxTask anomalyDetectionDecideTask1 = new AxTask(new AxArtifactKey("AnomalyDetectionDecideTask1", "0.0.1"));
        ...
        anomalyDetectionDecideTask1.setTaskLogic(new AxTaskLogic(anomalyDetectionDecideTask1.getKey(), "TaskLogic", "MVEL", logicReader));

        final AxTask anomalyDetectionDecideTask2 = new AxTask(new AxArtifactKey("AnomalyDetectionDecideTask2", "0.0.1"));
        ...
        anomalyDetectionDecideTask2.setTaskLogic(new AxTaskLogic(anomalyDetectionDecideTask2.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        anomalyDetectionActTask.setTaskLogic(new AxTaskLogic(anomalyDetectionActTask.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        final AxState anomalyDetectionActState = new AxState(new AxReferenceKey(anomalyDetectionPolicy.getKey(), "Act"));
        anomalyDetectionActState.setTrigger(anomalyDetectionDecideEvent.getKey());
        final AxStateOutput adAct2Out = new AxStateOutput(anomalyDetectionActState.getKey(), AxReferenceKey.getNullKey(), anomalyDetectionActEvent.getKey());
        anomalyDetectionActState.getStateOutputs().put(adAct2Out.getKey().getLocalName(), adAct2Out);
        anomalyDetectionActState.setTaskSelectionLogic(new AxTaskSelectionLogic(anomalyDetectionActState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        anomalyDetectionActState.setDefaultTask(anomalyDetectionActTask.getKey());
        anomalyDetectionActState.getTaskReferences().put(anomalyDetectionActTask.getKey(), new AxStateTaskReference(anomalyDetectionActState.getKey(),
                anomalyDetectionActTask.getKey(), AxStateTaskOutputType.DIRECT, adAct2Out.getKey()));

        logicReader.setDefaultLogic(null);

        final AxState anomalyDetectionDecideState = new AxState(new AxReferenceKey(anomalyDetectionPolicy.getKey(), "Decide"));
        anomalyDetectionDecideState.setTrigger(anomalyDetectionEstablishEvent.getKey());
        final AxStateOutput adDec2Act = new AxStateOutput(anomalyDetectionDecideState.getKey(), anomalyDetectionActState.getKey(),
                anomalyDetectionDecideEvent.getKey());
        anomalyDetectionDecideState.getStateOutputs().put(adDec2Act.getKey().getLocalName(), adDec2Act);
        anomalyDetectionDecideState
                .setTaskSelectionLogic(new AxTaskSelectionLogic(anomalyDetectionDecideState.getKey(), "TaskSelectionLogic", "JAVA", logicReader));
        ...
        anomalyDetectionDecideState.getTaskReferences().put(anomalyDetectionDecideTask0.getKey(), new AxStateTaskReference(anomalyDetectionDecideState.getKey(),
                anomalyDetectionDecideTask0.getKey(), AxStateTaskOutputType.DIRECT, adDec2Act.getKey()));
        anomalyDetectionDecideState.getTaskReferences().put(anomalyDetectionDecideTask1.getKey(), new AxStateTaskReference(anomalyDetectionDecideState.getKey(),
                anomalyDetectionDecideTask1.getKey(), AxStateTaskOutputType.DIRECT, adDec2Act.getKey()));
        anomalyDetectionDecideState.getTaskReferences().put(anomalyDetectionDecideTask2.getKey(), new AxStateTaskReference(anomalyDetectionDecideState.getKey(),
                anomalyDetectionDecideTask2.getKey(), AxStateTaskOutputType.DIRECT, adDec2Act.getKey()));

        logicReader.setDefaultLogic("DefaultState_Logic");

        final AxState anomalyDetectionEstablishState = new AxState(new AxReferenceKey(anomalyDetectionPolicy.getKey(), "Establish"));
        anomalyDetectionEstablishState.setTrigger(anomalyDetectionMatchEvent.getKey());
        final AxStateOutput adEst2Dec = new AxStateOutput(anomalyDetectionEstablishState.getKey(), anomalyDetectionDecideState.getKey(),
                anomalyDetectionEstablishEvent.getKey());
        anomalyDetectionEstablishState.getStateOutputs().put(adEst2Dec.getKey().getLocalName(), adEst2Dec);
        anomalyDetectionEstablishState
                .setTaskSelectionLogic(new AxTaskSelectionLogic(anomalyDetectionEstablishState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        anomalyDetectionEstablishState.setDefaultTask(anomalyDetectionEstablishTask.getKey());
        anomalyDetectionEstablishState.getTaskReferences().put(anomalyDetectionEstablishTask.getKey(), new AxStateTaskReference(
                anomalyDetectionEstablishState.getKey(), anomalyDetectionEstablishTask.getKey(), AxStateTaskOutputType.DIRECT, adEst2Dec.getKey()));

        final AxState anomalyDetectionMatchState = new AxState(new AxReferenceKey(anomalyDetectionPolicy.getKey(), "Match"));
        anomalyDetectionMatchState.setTrigger(anomalyDetectionTriggerEvent.getKey());
        final AxStateOutput adMat2Est = new AxStateOutput(anomalyDetectionMatchState.getKey(), anomalyDetectionEstablishState.getKey(),
                anomalyDetectionMatchEvent.getKey());
        anomalyDetectionMatchState.getStateOutputs().put(adMat2Est.getKey().getLocalName(), adMat2Est);
        anomalyDetectionMatchState
                .setTaskSelectionLogic(new AxTaskSelectionLogic(anomalyDetectionMatchState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        anomalyDetectionMatchState.setDefaultTask(anomalyDetectionMatchTask.getKey());
        anomalyDetectionMatchState.getTaskReferences().put(anomalyDetectionMatchTask.getKey(), new AxStateTaskReference(anomalyDetectionMatchState.getKey(),
                anomalyDetectionMatchTask.getKey(), AxStateTaskOutputType.DIRECT, adMat2Est.getKey()));

        anomalyDetectionPolicy.setFirstState(anomalyDetectionMatchState.getKey().getLocalName());
        anomalyDetectionPolicy.getStateMap().put(anomalyDetectionMatchState.getKey().getLocalName(), anomalyDetectionMatchState);
        anomalyDetectionPolicy.getStateMap().put(anomalyDetectionEstablishState.getKey().getLocalName(), anomalyDetectionEstablishState);
        anomalyDetectionPolicy.getStateMap().put(anomalyDetectionDecideState.getKey().getLocalName(), anomalyDetectionDecideState);
        anomalyDetectionPolicy.getStateMap().put(anomalyDetectionActState.getKey().getLocalName(), anomalyDetectionActState);

        final AxPolicies anomalyDetectionPolicies = new AxPolicies(new AxArtifactKey("AnomalyDetectionPolicies", "0.0.1"));
        anomalyDetectionPolicies.getPolicyMap().put(anomalyDetectionPolicy.getKey(), anomalyDetectionPolicy);

        final AxKeyInformation keyInformation = new AxKeyInformation(new AxArtifactKey("AnomalyDetectionKeyInformation", "0.0.1"));
        final AxPolicyModel anomalyDetectionPolicyModel = new AxPolicyModel(new AxArtifactKey("AnomalyDetectionPolicyModel", "0.0.1"));
    ...
    public AxPolicyModel getAutoLearnPolicyModel() {
       ...
       // Data types for event parameters
        ...
        final AxEvent autoLearnTriggerEvent = new AxEvent(new AxArtifactKey("AutoLearnTriggerEvent", "0.0.1"), "com.ericsson.apex.domains.adaptive.events");
        autoLearnTriggerEvent.setSource("External");
        autoLearnTriggerEvent.setTarget("Match");
        autoLearnTriggerEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(autoLearnTriggerEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        autoLearnTriggerEvent.getParameterMap().put("LastMonitoredValue",
                new AxField(new AxReferenceKey(autoLearnTriggerEvent.getKey(), "LastMonitoredValue"), monitoredValue.getKey()));

        final AxEvent autoLearnMatchEvent = new AxEvent(new AxArtifactKey("AutoLearnMatchEvent", "0.0.1"), "com.ericsson.apex.domains.adaptive.events");
        autoLearnMatchEvent.setSource("Match");
        autoLearnMatchEvent.setTarget("Establish");
        autoLearnMatchEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(autoLearnMatchEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        autoLearnMatchEvent.getParameterMap().put("LastMonitoredValue",
                new AxField(new AxReferenceKey(autoLearnMatchEvent.getKey(), "LastMonitoredValue"), monitoredValue.getKey()));

        final AxEvent autoLearnEstablishEvent = new AxEvent(new AxArtifactKey("AutoLearnEstablishEvent", "0.0.1"), "com.ericsson.apex.domains.adaptive.events");
        autoLearnEstablishEvent.setSource("Establish");
        autoLearnEstablishEvent.setTarget("Decide");
        autoLearnEstablishEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(autoLearnEstablishEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        autoLearnEstablishEvent.getParameterMap().put("LastMonitoredValue",
                new AxField(new AxReferenceKey(autoLearnEstablishEvent.getKey(), "LastMonitoredValue"), monitoredValue.getKey()));

        final AxEvent autoLearnDecideEvent = new AxEvent(new AxArtifactKey("AutoLearnDecideEvent", "0.0.1"), "com.ericsson.apex.domains.adaptive.events");
        autoLearnDecideEvent.setSource("Decide");
        autoLearnDecideEvent.setTarget("Act");
        autoLearnDecideEvent.getParameterMap().put("MonitoredValue",
                new AxField(new AxReferenceKey(autoLearnDecideEvent.getKey(), "MonitoredValue"), monitoredValue.getKey()));
        autoLearnDecideEvent.getParameterMap().put("LastMonitoredValue",
                new AxField(new AxReferenceKey(autoLearnDecideEvent.getKey(), "LastMonitoredValue"), monitoredValue.getKey()));

        final AxEvent autoLearnActEvent = new AxEvent(new AxArtifactKey("AutoLearnActEvent", "0.0.1"), "com.ericsson.apex.domains.adaptive.events");
        ...
        autoLearnActEvent.getParameterMap().put("LastMonitoredValue",
                new AxField(new AxReferenceKey(autoLearnActEvent.getKey(), "LastMonitoredValue"), monitoredValue.getKey()));
        ...
        final AxContextSchema autoLearn = new AxContextSchema(new AxArtifactKey("AutoLearn", "0.0.1"), "Java",
                "com.ericsson.apex.domains.adaptive.concepts.AutoLearn");
        alContextSchemas.getSchemasMap().put(autoLearn.getKey(), autoLearn);

        // One context map
        final AxContextAlbum autoLearnAlbum = new AxContextAlbum(new AxArtifactKey("AutoLearnAlbum", "0.0.1"), "APPLICATION", true, autoLearn.getKey());
        ...
        autoLearnEstablishTask.setTaskLogic(new AxTaskLogic(autoLearnEstablishTask.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        autoLearnDecideTask0.setTaskLogic(new AxTaskLogic(autoLearnDecideTask0.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        autoLearnDecideTask1.setTaskLogic(new AxTaskLogic(autoLearnDecideTask1.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        autoLearnDecideTask2.setTaskLogic(new AxTaskLogic(autoLearnDecideTask2.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        autoLearnDecideTask3.setTaskLogic(new AxTaskLogic(autoLearnDecideTask3.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        autoLearnDecideTask4.setTaskLogic(new AxTaskLogic(autoLearnDecideTask4.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        autoLearnDecideTask5.setTaskLogic(new AxTaskLogic(autoLearnDecideTask5.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        autoLearnDecideTask6.setTaskLogic(new AxTaskLogic(autoLearnDecideTask6.getKey(), "TaskLogic", "MVEL", logicReader));
        ...
        final AxStateOutput alAct2Out = new AxStateOutput(autoLearnActState.getKey(), AxReferenceKey.getNullKey(), autoLearnActEvent.getKey());
        autoLearnActState.getStateOutputs().put(alAct2Out.getKey().getLocalName(), alAct2Out);
        autoLearnActState.setTaskSelectionLogic(new AxTaskSelectionLogic(autoLearnActState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        autoLearnActState.setDefaultTask(autoLearnActTask.getKey());
        autoLearnActState.getTaskReferences().put(autoLearnActTask.getKey(),
                new AxStateTaskReference(autoLearnActState.getKey(), autoLearnActTask.getKey(), AxStateTaskOutputType.DIRECT, alAct2Out.getKey()));
        ...
        final AxStateOutput alDec2Act = new AxStateOutput(autoLearnDecideState.getKey(), autoLearnActState.getKey(), autoLearnDecideEvent.getKey());
        ...
        autoLearnDecideState.setTaskSelectionLogic(new AxTaskSelectionLogic(autoLearnDecideState.getKey(), "TaskSelectionLogic", "JAVA", logicReader));
        ...
        autoLearnDecideState.getTaskReferences().put(autoLearnDecideTask0.getKey(),
                new AxStateTaskReference(autoLearnDecideState.getKey(), autoLearnDecideTask0.getKey(), AxStateTaskOutputType.DIRECT, alDec2Act.getKey()));
        autoLearnDecideState.getTaskReferences().put(autoLearnDecideTask1.getKey(),
                new AxStateTaskReference(autoLearnDecideState.getKey(), autoLearnDecideTask1.getKey(), AxStateTaskOutputType.DIRECT, alDec2Act.getKey()));
        autoLearnDecideState.getTaskReferences().put(autoLearnDecideTask2.getKey(),
                new AxStateTaskReference(autoLearnDecideState.getKey(), autoLearnDecideTask2.getKey(), AxStateTaskOutputType.DIRECT, alDec2Act.getKey()));
        autoLearnDecideState.getTaskReferences().put(autoLearnDecideTask3.getKey(),
                new AxStateTaskReference(autoLearnDecideState.getKey(), autoLearnDecideTask3.getKey(), AxStateTaskOutputType.DIRECT, alDec2Act.getKey()));
        autoLearnDecideState.getTaskReferences().put(autoLearnDecideTask4.getKey(),
                new AxStateTaskReference(autoLearnDecideState.getKey(), autoLearnDecideTask4.getKey(), AxStateTaskOutputType.DIRECT, alDec2Act.getKey()));
        autoLearnDecideState.getTaskReferences().put(autoLearnDecideTask5.getKey(),
                new AxStateTaskReference(autoLearnDecideState.getKey(), autoLearnDecideTask5.getKey(), AxStateTaskOutputType.DIRECT, alDec2Act.getKey()));
        autoLearnDecideState.getTaskReferences().put(autoLearnDecideTask6.getKey(),
                new AxStateTaskReference(autoLearnDecideState.getKey(), autoLearnDecideTask6.getKey(), AxStateTaskOutputType.DIRECT, alDec2Act.getKey()));
        ...
        final AxStateOutput alEst2Dec = new AxStateOutput(autoLearnEstablishState.getKey(), autoLearnDecideState.getKey(), autoLearnEstablishEvent.getKey());
        autoLearnEstablishState.getStateOutputs().put(alEst2Dec.getKey().getLocalName(), alEst2Dec);
        autoLearnEstablishState.setTaskSelectionLogic(new AxTaskSelectionLogic(autoLearnEstablishState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        ...
        autoLearnEstablishState.getTaskReferences().put(autoLearnEstablishTask.getKey(),
                new AxStateTaskReference(autoLearnEstablishState.getKey(), autoLearnEstablishTask.getKey(), AxStateTaskOutputType.DIRECT, alEst2Dec.getKey()));
        ...
        final AxStateOutput alMat2Est = new AxStateOutput(autoLearnMatchState.getKey(), autoLearnEstablishState.getKey(), autoLearnMatchEvent.getKey());
        autoLearnMatchState.getStateOutputs().put(alMat2Est.getKey().getLocalName(), alMat2Est);
        autoLearnMatchState.setTaskSelectionLogic(new AxTaskSelectionLogic(autoLearnMatchState.getKey(), "TaskSelectionLogic", "MVEL", logicReader));
        ...
        autoLearnMatchState.getTaskReferences().put(autoLearnMatchTask.getKey(),
                new AxStateTaskReference(autoLearnMatchState.getKey(), autoLearnMatchTask.getKey(), AxStateTaskOutputType.DIRECT, alMat2Est.getKey()));
        ...
        final AxKeyInformation keyInformation = new AxKeyInformation(new AxArtifactKey("AutoLearnKeyInformation", "0.0.1"));
        final AxPolicyModel autoLearnPolicyModel = new AxPolicyModel(new AxArtifactKey("AutoLearnPolicyModel", "0.0.1"));
