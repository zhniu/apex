 ...
 * JUnit test class
 */
public class EclipselinkEntityTest {
	...
	public void testEntityTestAllOpsHibernate() throws ApexException {
		...
		parameters.setPersistenceUnit("EclipselinkTest");
		parameters.setPluginClass("com.ericsson.apex.plugins.persistence.jpa.eclipselink.EclipselinkApexDao");
