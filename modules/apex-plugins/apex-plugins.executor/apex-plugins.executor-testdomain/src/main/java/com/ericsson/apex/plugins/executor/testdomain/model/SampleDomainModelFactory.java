...
public class SampleDomainModelFactory {
    ...
    public AxPolicyModel getSamplePolicyModel(final String axLogicExecutorType) {
        AxContextSchema testSlogan = new AxContextSchema(new AxArtifactKey("TestSlogan", "0.0.1"), "Java", "java.lang.String");
        AxContextSchema testCase = new AxContextSchema(new AxArtifactKey("TestCase", "0.0.1"), "Java", "java.lang.Byte");
        AxContextSchema testTimestamp = new AxContextSchema(new AxArtifactKey("TestTimestamp", "0.0.1"), "Java", "java.lang.Long");
        AxContextSchema testTemperature = new AxContextSchema(new AxArtifactKey("TestTemperature", "0.0.1"), "Java", "java.lang.Double");

        AxContextSchema testContextItem000 = new AxContextSchema(new AxArtifactKey("TestContextItem000", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem000");
        AxContextSchema testContextItem001 = new AxContextSchema(new AxArtifactKey("TestContextItem001", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem001");
        AxContextSchema testContextItem002 = new AxContextSchema(new AxArtifactKey("TestContextItem002", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem002");
        AxContextSchema testContextItem003 = new AxContextSchema(new AxArtifactKey("TestContextItem003", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem003");
        AxContextSchema testContextItem004 = new AxContextSchema(new AxArtifactKey("TestContextItem004", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem004");
        AxContextSchema testContextItem005 = new AxContextSchema(new AxArtifactKey("TestContextItem005", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem005");
        AxContextSchema testContextItem006 = new AxContextSchema(new AxArtifactKey("TestContextItem006", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem006");
        AxContextSchema testContextItem007 = new AxContextSchema(new AxArtifactKey("TestContextItem007", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem007");
        AxContextSchema testContextItem008 = new AxContextSchema(new AxArtifactKey("TestContextItem008", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem008");
        AxContextSchema testContextItem009 = new AxContextSchema(new AxArtifactKey("TestContextItem009", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem009");
        AxContextSchema testContextItem00A = new AxContextSchema(new AxArtifactKey("TestContextItem00A", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem00A");
        AxContextSchema testContextItem00B = new AxContextSchema(new AxArtifactKey("TestContextItem00B", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem00B");
        AxContextSchema testContextItem00C = new AxContextSchema(new AxArtifactKey("TestContextItem00C", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestContextItem00C");

        AxContextSchema testPolicyContextItem = new AxContextSchema(new AxArtifactKey("TestPolicyContextItem", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestPolicyContextItem");
        AxContextSchema testGlobalContextItem = new AxContextSchema(new AxArtifactKey("TestGlobalContextItem", "0.0.1"), "Java",
                "com.ericsson.apex.context.test.concepts.TestGlobalContextItem");
        AxContextSchema testExternalContextItem = new AxContextSchema(new AxArtifactKey("TestExternalContextItem", "0.0.1"), "Java",
        ...
        AxEvent event0000 = new AxEvent(new AxArtifactKey("Event0000", "0.0.1"), "com.ericsson.apex.sample.events");
        event0000.setSource("Outside");
        event0000.setTarget("Match");
        event0000.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0000.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0000.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0000.getKey(), "TestMatchCase"), testCase.getKey()));
        event0000.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0000.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0000.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0000.getKey(), "TestTemperature"), testTemperature.getKey()));

        AxEvent event0001 = new AxEvent(new AxArtifactKey("Event0001", "0.0.1"), "com.ericsson.apex.sample.events");
        event0001.setSource("Match");
        event0001.setTarget("Establish");
        event0001.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0001.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0001.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0001.getKey(), "TestMatchCase"), testCase.getKey()));
        event0001.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0001.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0001.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0001.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        AxEvent event0002 = new AxEvent(new AxArtifactKey("Event0002", "0.0.1"), "com.ericsson.apex.sample.events");
        event0002.setSource("Establish");
        event0002.setTarget("Decide");
        event0002.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0002.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0002.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0002.getKey(), "TestMatchCase"), testCase.getKey()));
        event0002.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0002.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0002.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0002.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        AxEvent event0003 = new AxEvent(new AxArtifactKey("Event0003", "0.0.1"), "com.ericsson.apex.sample.events");
        event0003.setSource("Decide");
        event0003.setTarget("Act");
        event0003.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0003.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0003.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0003.getKey(), "TestMatchCase"), testCase.getKey()));
        event0003.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0003.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0003.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0003.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        AxEvent event0004 = new AxEvent(new AxArtifactKey("Event0004", "0.0.1"), "com.ericsson.apex.sample.events");
        event0004.setSource("Act");
        event0004.setTarget("Outside");
        event0004.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0004.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0004.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0004.getKey(), "TestMatchCase"), testCase.getKey()));
        event0004.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0004.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0004.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0004.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        event0004.getParameterMap().put("TestActCaseSelected", new AxField(new AxReferenceKey(event0004.getKey(), "TestActCaseSelected"), testCase.getKey()));
        event0004.getParameterMap().put("TestActStateTime", new AxField(new AxReferenceKey(event0004.getKey(), "TestActStateTime"), testTimestamp.getKey()));

        AxEvent event0100 = new AxEvent(new AxArtifactKey("Event0100", "0.0.1"), "com.ericsson.apex.sample.events");
        event0100.setSource("Outside");
        event0100.setTarget("Match");
        event0100.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0100.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0100.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0100.getKey(), "TestMatchCase"), testCase.getKey()));
        event0100.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0100.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0100.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0100.getKey(), "TestTemperature"), testTemperature.getKey()));

        AxEvent event0101 = new AxEvent(new AxArtifactKey("Event0101", "0.0.1"), "com.ericsson.apex.sample.events");
        event0101.setSource("Match");
        event0101.setTarget("Establish");
        event0101.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0101.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0101.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0101.getKey(), "TestMatchCase"), testCase.getKey()));
        event0101.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0101.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0101.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0101.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        AxEvent event0102 = new AxEvent(new AxArtifactKey("Event0102", "0.0.1"), "com.ericsson.apex.sample.events");
        event0102.setSource("Establish");
        event0102.setTarget("Decide");
        event0102.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0102.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0102.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0102.getKey(), "TestMatchCase"), testCase.getKey()));
        event0102.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0102.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0102.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0102.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        AxEvent event0103 = new AxEvent(new AxArtifactKey("Event0103", "0.0.1"), "com.ericsson.apex.sample.events");
        event0103.setSource("Decide");
        event0103.setTarget("Act");
        event0103.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0103.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0103.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0103.getKey(), "TestMatchCase"), testCase.getKey()));
        event0103.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0103.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0103.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0103.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        AxEvent event0104 = new AxEvent(new AxArtifactKey("Event0104", "0.0.1"), "com.ericsson.apex.sample.events");
        event0104.setSource("Act");
        event0104.setTarget("Outside");
        event0104.getParameterMap().put("TestSlogan", new AxField(new AxReferenceKey(event0104.getKey(), "TestSlogan"), testSlogan.getKey()));
        event0104.getParameterMap().put("TestMatchCase", new AxField(new AxReferenceKey(event0104.getKey(), "TestMatchCase"), testCase.getKey()));
        event0104.getParameterMap().put("TestTimestamp", new AxField(new AxReferenceKey(event0104.getKey(), "TestTimestamp"), testTimestamp.getKey()));
        event0104.getParameterMap().put("TestTemperature", new AxField(new AxReferenceKey(event0104.getKey(), "TestTemperature"), testTemperature.getKey()));
        ...
        event0104.getParameterMap().put("TestActCaseSelected", new AxField(new AxReferenceKey(event0104.getKey(), "TestActCaseSelected"), testCase.getKey()));
        event0104.getParameterMap().put("TestActStateTime", new AxField(new AxReferenceKey(event0104.getKey(), "TestActStateTime"), testTimestamp.getKey()));
        ...
        AxContextAlbum globalContextAlbum = new AxContextAlbum(new AxArtifactKey("GlobalContextAlbum", "0.0.1"), "GLOBAL", true,
                testGlobalContextItem.getKey());
        ...
        tasks.getTaskMap().putAll(getTaskMap("Match", event0000.getParameterMap(), event0001.getParameterMap(), referenceKeySetList, axLogicExecutorType));
        tasks.getTaskMap().putAll(getTaskMap("Establish", event0001.getParameterMap(), event0002.getParameterMap(), referenceKeySetList, axLogicExecutorType));
        tasks.getTaskMap().putAll(getTaskMap("Decide", event0002.getParameterMap(), event0003.getParameterMap(), referenceKeySetList, axLogicExecutorType));
        tasks.getTaskMap().putAll(getTaskMap("Act", event0003.getParameterMap(), event0004.getParameterMap(), referenceKeySetList, axLogicExecutorType));
        ...
        policy0.setStateMap(
                getStateMap(policy0.getKey(), p0InEventList, p0OutEventList, p0ReferenceKeySetList, axLogicExecutorType, p0defaultTaskList, taskReferenceList));
        ...
        policy1.setStateMap(
                getStateMap(policy1.getKey(), p1InEventList, p1OutEventList, p1ReferenceKeySetList, axLogicExecutorType, p1defaultTaskList, taskReferenceList));
        ...
        AxPolicyModel policyModel = new AxPolicyModel(new AxArtifactKey("SamplePolicyModel" + axLogicExecutorType, "0.0.1"));
     ...
     */
    private Map<String, AxState> getStateMap(final AxArtifactKey policyKey, final List<AxArtifactKey> inEventKeyList, final List<AxArtifactKey> outEventKeyList,
            final List<Set<AxArtifactKey>> referenceKeySetList, final String axLogicExecutorType, final List<AxArtifactKey> defaultTaskList,
            final List<Set<AxArtifactKey>> taskKeySetList) {
        AxLogicReader logicReader = new PolicyLogicReader().setLogicPackage(this.getClass().getPackage().getName()).setDefaultLogic("DefaultState_Logic");

        AxState actState = new AxState(new AxReferenceKey(policyKey, "Act"));
        actState.setTrigger(inEventKeyList.get(3));
        AxStateOutput act2Out = new AxStateOutput(actState.getKey(), AxReferenceKey.getNullKey(), outEventKeyList.get(3));
        ...
        actState.setTaskSelectionLogic(new AxTaskSelectionLogic(actState.getKey(), "TaskSelectionLigic", axLogicExecutorType, logicReader));
        actState.setDefaultTask(defaultTaskList.get(3));
        for (AxArtifactKey taskKey : taskKeySetList.get(3)) {
            actState.getTaskReferences().put(taskKey, new AxStateTaskReference(actState.getKey(), taskKey, AxStateTaskOutputType.DIRECT, act2Out.getKey()));
        }
        ...
        decideState.setTaskSelectionLogic(new AxTaskSelectionLogic(decideState.getKey(), "TaskSelectionLigic", axLogicExecutorType, logicReader));
        decideState.setDefaultTask(defaultTaskList.get(2));
        for (AxArtifactKey taskKey : taskKeySetList.get(2)) {
            decideState.getTaskReferences().put(taskKey,
                    new AxStateTaskReference(decideState.getKey(), taskKey, AxStateTaskOutputType.DIRECT, decide2Act.getKey()));
        }

        AxState establishState = new AxState(new AxReferenceKey(policyKey, "Establish"));
        establishState.setTrigger(inEventKeyList.get(1));
        AxStateOutput establish2Decide = new AxStateOutput(establishState.getKey(), decideState.getKey(), outEventKeyList.get(1));
        ...
        establishState.setTaskSelectionLogic(new AxTaskSelectionLogic(establishState.getKey(), "TaskSelectionLigic", axLogicExecutorType, logicReader));
        establishState.setDefaultTask(defaultTaskList.get(1));
        for (AxArtifactKey taskKey : taskKeySetList.get(1)) {
            establishState.getTaskReferences().put(taskKey,
                    new AxStateTaskReference(establishState.getKey(), taskKey, AxStateTaskOutputType.DIRECT, establish2Decide.getKey()));
        }

        AxState matchState = new AxState(new AxReferenceKey(policyKey, "Match"));
        matchState.setTrigger(inEventKeyList.get(0));
        AxStateOutput match2Establish = new AxStateOutput(matchState.getKey(), establishState.getKey(), outEventKeyList.get(0));
        ...
        matchState.setTaskSelectionLogic(new AxTaskSelectionLogic(matchState.getKey(), "TaskSelectionLigic", axLogicExecutorType, logicReader));
        matchState.setDefaultTask(defaultTaskList.get(0));
        for (AxArtifactKey taskKey : taskKeySetList.get(0)) {
            matchState.getTaskReferences().put(taskKey,
                    new AxStateTaskReference(matchState.getKey(), taskKey, AxStateTaskOutputType.DIRECT, match2Establish.getKey()));
        }
     ...
     * @return the task map
     */
    private Map<AxArtifactKey, AxTask> getTaskMap(final String state, final Map<String, AxField> inputFields, final Map<String, AxField> outputFields,
            final List<Set<AxArtifactKey>> referenceKeySetList, final String axLogicExecutorType) {
        AxLogicReader logicReader = new PolicyLogicReader().setLogicPackage(this.getClass().getPackage().getName()).setDefaultLogic("DefaultTask_Logic");
        ...
        AxTaskParameter parameter00 = new AxTaskParameter(new AxReferenceKey(testTask0.getKey(), "Parameter0"), "DefaultValue0");
        AxTaskParameter parameter01 = new AxTaskParameter(new AxReferenceKey(testTask0.getKey(), "Parameter1"), "DefaultValue1");
        AxTaskParameter parameter02 = new AxTaskParameter(new AxReferenceKey(testTask0.getKey(), "Parameter2"), "DefaultValue2");
        ...
        AxTaskParameter parameter10 = new AxTaskParameter(new AxReferenceKey(testTask1.getKey(), "Parameter0"), "DefaultValue0");
        AxTaskParameter parameter11 = new AxTaskParameter(new AxReferenceKey(testTask1.getKey(), "Parameter1"), "DefaultValue1");
        ...
        AxTaskParameter parameter20 = new AxTaskParameter(new AxReferenceKey(testTask2.getKey(), "Parameter0"), "DefaultValue0");
        ...
        AxTaskParameter parameter30 = new AxTaskParameter(new AxReferenceKey(testTask3.getKey(), "Parameter0"), "DefaultValue0");
     ...
     */
    private AxTaskLogic getTaskLogic(final AxTask task, final AxLogicReader logicReader, final String logicFlavour, final String stateName,
            final String caseToUse) {
        AxTaskLogic axLogic = new AxTaskLogic(new AxReferenceKey(task.getKey(), "_TaskLogic"), logicFlavour, logicReader);

        axLogic.setLogic(axLogic.getLogic().replaceAll("<STATE_NAME>", stateName).replaceAll("<TASK_NAME>", task.getKey().getName())
