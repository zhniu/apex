...
public class TestContext implements Context {
    ...
    public TestContext() {
        try {
            ...
            testProperties.put("ConnectionFactory", factory);
            testProperties.put("jms/topic/apexIn", HornetQJMSClient.createTopic("jms/topic/apexIn"));
            testProperties.put("jms/topic/apexOut", HornetQJMSClient.createTopic("jms/topic/apexOut"));
        }
        catch (Exception e) {
            e.printStackTrace();
