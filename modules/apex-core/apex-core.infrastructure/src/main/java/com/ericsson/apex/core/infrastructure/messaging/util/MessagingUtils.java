...
package com.ericsson.apex.core.infrastructure.messaging.util;
...
/**
 * The Class MessagingUtils is a class with static methods used in IPC messaging for finding free ports, translating host names to addresses, serializing
 * objects and flushing object streams.
 *
...
public final class MessagingUtils {
    ...
    /**
     * This method searches the availability of the port, if the requested port not available, this method will throw an exception.
     *
    ...
    /**
     * This method searches the availability of the port, if the requested port not available,this method will increment the port number and check the
     * availability of that port, this process will continue until it find port available.
     *
    ...
    /**
     * This method searches the availability of the port, if the requested port not available,this method will increment the port number and check the
     * availability, this process will continue until it find port available.
     *
     * @param port the first port to check
     * @return the port that was found
     * @throws RuntimeException on port allocation errors
