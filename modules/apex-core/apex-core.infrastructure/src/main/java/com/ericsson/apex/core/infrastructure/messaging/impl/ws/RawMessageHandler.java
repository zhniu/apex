...
/**
 * The Class RawMessageHandler handles raw messages being received on a Java web socket and forwards the messages to the DataHandler instance that has
 * subscribed to the RawMessageHandler instance.
 *
...
public class RawMessageHandler<MESSAGE> implements WebSocketMessageListener<MESSAGE>, Runnable {
    ...
    public void onMessage(final RawMessageBlock incomingData) {
        ...
        // Read the messages from the web socket and place them on the message queue for handling by the queue processing thread
