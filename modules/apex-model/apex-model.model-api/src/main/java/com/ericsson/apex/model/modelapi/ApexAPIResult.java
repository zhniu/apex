...
/**
 * The Class ApexEditorAPIResult return the result of and messages from all model API method calls on the {@link ApexModel} API.
 */
@XmlRootElement
...
public class ApexAPIResult {
    ...
    public enum RESULT {
        ...
        FAILED,
        /** The method call failed for another reason such as the method call is not implemented yet on the concept on which it was called. */
        OTHER_ERROR
    }
    ...
    /**
     * This Constructor creates a result with the given result status and {@link Throwable} object such as an exception. The message and stack trace from the
    ...
    /**
     * This Constructor creates a result with the given result status, message, and {@link Throwable} object such as an exception. The message and stack trace
     * from the {@link Throwable} object are added to the message list of this message.
     *
     * @param result the result status to use on this result
     * @param message the message to return with the result
     * @param throwable the throwable object from which to add the message and stack trace
    ...
    /**
     * Adds the message and stack trace from a {@link Throwable} object such as an exception from an API operation to the bottom of the list of messages to be
     * returned.
     *
     * @param throwable the {@link Throwable} object such as an exception from an API operation from which the message and stack trace are to be extracted and
     *            placed at the bottom of the list of messages to be returned
     */
