...
public class TestApexEditorAPIPolicy {
    ...
    public void MyTestPolicyCRUD() {
        ...
        result = apexModel.createPolicy("MyPolicy002", "0.0.2", "SomeTemplate", "AState", "1fa2e430-f2b2-11e6-bc64-92361f002700", "A description of 002");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.createPolicy("MyPolicy002", "0.0.2", "SomeTemplate", "AState", "1fa2e430-f2b2-11e6-bc64-92361f002700", "A description of 002");
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result = apexModel.createPolicy("MyPolicy013", null, null, "AState", null, null); //template is now optional, so this test passes
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.createPolicy("MyPolicy012", null, "SomeTemplate", "AState", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.createPolicy("MyPolicy002", "0.0.2", "SomeTemplate", "AState", "1fa2e430-f2b2-11e6-bc64-92361f002700", "A description of 002");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
        result = apexModel.createPolicy("MyPolicy012", "0.1.2", "SomeTemplate", "AState", "1fa2e430-f2b2-11e6-bc64-92361f002700", "A description of 002");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.createPolicy("MyTestPolicy", "0.0.1", "SomeTemplate", "TestState", "1fa2e430-f2b2-11e6-bc64-92361f002700", "A description of 002");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        result = apexModel.updatePolicy("MyPolicy002", "0.0.2", "SomeOtherTemplate", "BState", "1fa2e430-f2b2-11e6-bc64-92361f002700", "A description of 002");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        result=apexModel.createPolicyState("MyTestPolicy", "0.0.1", "TestState1", "inEvent", "0.0.1", "task", "0.0.1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));

        result=apexModel.createPolicyState("MyTestPolicy", "0.0.1", "TestState2", "outEvent0", "0.0.1", "task", "0.0.1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));

        result=apexModel.createPolicyState("MyTestPolicy", "0.0.1", "TestState3", "outEvent1", "0.0.1", "task", "0.0.1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1", "UNDEFINED", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1", "MVEL", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
   
        result=apexModel.deletePolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1", "JAVA", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1", "JYTHON", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
        result=apexModel.deletePolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskSelectionLogic("MyTestPolicy", null, "TestState1", "JAVASCRIPT", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.deletePolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskSelectionLogic("MyTestPolicy", null, "TestState1", "JRUBY", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1", "", "Some Other Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result = apexModel.updatePolicyStateTaskSelectionLogic("MyTestPolicy", "0.0.1", "TestState1", "MVEL", "Some Other Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.updatePolicyStateTaskSelectionLogic("MyPolicy012", null, "TestState1", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateTaskSelectionLogic("MyTestPolicy", null, "TestState1", null, "Some Other Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.updatePolicyStateTaskSelectionLogic("MyTestPolicy", null, "TestState1", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "1.2.3", "TestState1", "SomeOutput", null, null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOutput", null, null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOutput", "SomeDummyEvent", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOutput", "inEvent", "1.2.3", null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOutput", "inEvent", "0.0.1", "SomeDummyNextState");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOutput", "inEvent", "0.0.1", null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOtherOutput", "inEvent", "0.0.1", "TestState1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOtherOutput", "inEvent", "0.0.1", "TestState2");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState1", "SomeOtherOutput", "inEvent", "0.0.1", "TestState2");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState2", "AnotherOtherOutput", "outEvent0", "0.0.1", "TestState3");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateOutput("MyTestPolicy", "0.0.1", "TestState2", "YetAnotherOtherOutput", "outEvent0", "0.0.1", "TestState3");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "1.2.3", "TestState1", "SFLName01", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName01", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName01", "NewTSL00", null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName02", "UNDEFINED", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName03", "MVEL", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName03", "MVEL", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName04", "JAVA", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName05", "JYTHON", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", null, "TestState1", "SFLName06", "JAVASCRIPT", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateFinalizerLogic("MyTestPolicy", null, "TestState1", "SFLName07", "JRUBY", "Some Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy", null, "TestState99", "SomeSFLName", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy2", null, "TestState1", "SomeSFLName", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy1", "0.0.2", "TestState1", "SomeSFLName", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "NonEistantSFL", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName06", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName06", "", "Some Other Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy", "0.0.1", "TestState1", "SFLName06", "MVEL", "Some Other Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result = apexModel.updatePolicyStateFinalizerLogic("MyPolicy012", null, "TestState1", "SFLName06", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateFinalizerLogic("MyTestPolicy", null, "TestState1", "SFLName06", null, "Some Other Policy Logic");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result = apexModel.updatePolicyStateFinalizerLogic("MyPolicy014", "0.1.5", "TestState1", "SFLName06", null, null);
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        ...
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "SomeState", null, null, null, null, "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "1.2.3", "SomeState", null, null, null, null, "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("AnyOldPolicy", "1.2.3", "SomeState", null, null, null, null, "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "0.0.1", "TestState1", "SomeTaskLocalName", null, null, null, "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "0.0.1", "TestState1",  "SomeTaskLocalName", "SomeTask", "Zooby|", null, "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "0.0.1", "TestState1",  "SomeTaskLocalName", "SomeTask", "0.0.1", null, "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "0.0.1", "TestState1",  "SomeTaskLocalName", "task", "0.0.1", null, "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "0.0.1", "TestState1",  "SomeTaskLocalName", "task", "0.0.1", "Some Policy Logic", "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "0.0.1", "TestState1",  "SomeTaskLocalName", "task", "0.0.1", "DIRECT", "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", "0.0.1", "TestState1",  "SomeTaskLocalName", "task", "0.0.1", "LOGIC", "DummyOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "task", "0.0.1", "DIRECT", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "task", "0.0.1", "LOGIC", "SomeOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "task", "0.0.1", "DIRECT", "SomeOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "NonExistantTask", "0.0.1", "DIRECT", "SomeOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_DOES_NOT_EXIST));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "task", "0.0.1", "LOGIC", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "TestTask0", "0.0.1", "LOGIC", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "TestTask1", "0.0.1", "DIRECT", "SomeOtherOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "TestTask2", "0.0.1", "LOGIC", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "TestTask3", "0.0.1", "DIRECT", "SomeOtherOutput");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  null, "TestTask4", "0.0.1", "LOGIC", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  null, "TestTask4", "0.0.1", "LOGIC", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
        result=apexModel.deletePolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "TestTask4", "0.0.1");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "TestTask4", "0.0.1", "FUNKY", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "TestTask4", "0.0.1", "UNDEFINED", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.FAILED));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  "SomeTaskLocalName", "TestTask4", "0.0.1", "LOGIC", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.SUCCESS));
        result=apexModel.createPolicyStateTaskRef("MyTestPolicy", null, "TestState1",  null, "TestTask0", "0.0.1", "LOGIC", "SFLName07");
        assertTrue(result.getResult().equals(ApexAPIResult.RESULT.CONCEPT_EXISTS));
