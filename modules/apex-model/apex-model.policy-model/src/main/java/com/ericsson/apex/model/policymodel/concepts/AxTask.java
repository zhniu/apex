...
public class AxTask extends AxConcept {
	 ...
	 */
	private AxValidationResult validateField(final String fieldKey, final AxField field, final String direction, AxValidationResult result) {
		if (field == null) {
			result.addValidationMessage(new AxValidationMessage(key, this.getClass(), ValidationResult.INVALID,
	 ...
	 * @return The result of the validation
	 */
	private AxValidationResult vaildateTaskParameterEntry(final Entry<String, AxTaskParameter> taskParameterEntry, 	AxValidationResult result) {
	 ...
	 * @return The result of the validation
	 */
	private AxValidationResult vaildateContextAlbumReference(final AxArtifactKey contextAlbumReference, AxValidationResult result) {
