...
/**
 * This class is a java bean that is used to record statistics on Apex engines as they execute. Statistics on the number of events, the amount of time taken to
 * execute the last policy, the average policy execution time, the up time of the engine, and the time stamp of the last engine start are recorded.
 */
// @formatter:off
@Entity
...
public class AxEngineStats extends AxConcept {
   ...
   /**
     ...
     */
    public AxEngineStats(final AxReferenceKey key, final long timeStamp, final long eventCount, final long lastExecutionTime, final double averageExecutionTime,
            final long upTime, final long lastStart) {
        super();
