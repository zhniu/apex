...
/**
 * A container class for an Apex engine model. This class is a container class that allows an Apex model to be constructed that contains the current context
 * {@link AxContextModel}, current state {@link AxEngineState} and current statistics {@link AxEngineStats} of an Apex engine. This model is used by an Apex
 * engine to pass its current execution state to any system that wishes to query that information. The time stamp of the engine model is the time at which the
 * state and statistics of the engine were read.
 * <p>
 * Validation checks that the current state {@link AxEngineState} is defined and that the time stamp is set on the engine model.
 */
@Entity
@Table(name = "AxEngineModel")

@XmlRootElement(name = "apexEngineModel", namespace = "http://www.ericsson.com/apex")

@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "AxEngineModel", namespace = "http://www.ericsson.com/apex", propOrder = { "timestamp", "state", "stats" })
...
public class AxEngineModel extends AxContextModel {
    ...
    // @formatter:off
    @JoinColumns({
        @JoinColumn(name = "statsParentKeyName",     referencedColumnName = "parentKeyName",    updatable = false, insertable = false),
        @JoinColumn(name = "statsParentKeyVersion",  referencedColumnName = "parentKeyVersion", updatable = false, insertable = false),
        @JoinColumn(name = "statsParentLocalName ",  referencedColumnName = "parentLocalName",  updatable = false, insertable = false),
   ...
   /**
    ...
    /**
     * This Constructor creates an engine model with its context model data types all defined, the state of the engine model is undefined.
     *
     * @param key the engine model key
     ...
     */
    public AxEngineModel(final AxArtifactKey key, final AxContextSchemas contextSchemas, final AxKeyInformation keyInformation,
            final AxContextAlbums contextAlbums) {
     ...
     */
    public AxEngineModel(final AxArtifactKey key, final AxContextSchemas contextSchemas, final AxKeyInformation keyInformation,
            final AxContextAlbums contextAlbums, final AxEngineState state, final AxEngineStats stats) {
     ...
     * (non-Javadoc)
     *
     * @see com.ericsson.apex.model.contextmodel.concepts.AxContextModel#getKeys()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.ericsson.apex.model.contextmodel.concepts.AxContextModel#validate(com.ericsson.apex.model.basicmodel.concepts.AxValidationResult)
     */
    @Override
    public AxValidationResult validate(final AxValidationResult resultIn) {
        ...
        if (timestamp == -1) {
            result.addValidationMessage(
                    new AxValidationMessage(getKey(), this.getClass(), ValidationResult.INVALID, this.getClass().getSimpleName() + " - timestamp is not set"));
        }

        if (state == AxEngineState.UNDEFINED) {
            result.addValidationMessage(
                    new AxValidationMessage(getKey(), this.getClass(), ValidationResult.INVALID, this.getClass().getSimpleName() + " - state is UNDEFINED"));
        }
     ...
     * (non-Javadoc)
     *
     * @see com.ericsson.apex.model.contextmodel.concepts.AxContextModel#clean()
     */
    @Override
    public void clean() {
        super.clean();
     ...
     * (non-Javadoc)
     *
     * @see com.ericsson.apex.model.contextmodel.concepts.AxContextModel#toString()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.ericsson.apex.model.contextmodel.concepts.AxContextModel#hashCode()
     */
    @Override
    public int hashCode() {
        final int prime = 31;
     ...
     * (non-Javadoc)
     *
     * @see com.ericsson.apex.model.contextmodel.concepts.AxContextModel#equals(java.lang.Object)
     */
    @Override
    public boolean equals(final Object obj) {
        ...
        AxEngineModel other = (AxEngineModel) obj;
     ...
     * (non-Javadoc)
     *
     * @see com.ericsson.apex.model.contextmodel.concepts.AxContextModel#compareTo(com.ericsson.apex.model.basicmodel.concepts.AxConcept)
     */
    @Override
    public int compareTo(final AxConcept otherObj) {
        ...
        AxEngineModel other = (AxEngineModel) otherObj;
        if (!super.equals(other)) {
