...
public class ApexDeploymentRest {
	...
	public ApexDeploymentRest(final ApexDeploymentRestParameters parameters) {
		...
		// in com.ericsson.apex.services.client.deployment.rest package
		...
		// Add static content
		server.getServerConfiguration().addHttpHandler(new org.glassfish.grizzly.http.server.CLStaticHttpHandler(ApexDeploymentRestMain.class.getClassLoader(), "/webapp/"), parameters.getStaticPath());
