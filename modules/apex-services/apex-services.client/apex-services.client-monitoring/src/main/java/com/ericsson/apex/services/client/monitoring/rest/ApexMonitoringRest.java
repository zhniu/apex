...
public class ApexMonitoringRest {
	...
	public ApexMonitoringRest(final ApexMonitoringRestParameters parameters) {
		...
		// in com.ericsson.apex.services.client.monitoring.rest package
		...
		// Add static content
		server.getServerConfiguration().addHttpHandler(new org.glassfish.grizzly.http.server.CLStaticHttpHandler(ApexMonitoringRestMain.class.getClassLoader(), "/webapp/"), parameters.getStaticPath());
