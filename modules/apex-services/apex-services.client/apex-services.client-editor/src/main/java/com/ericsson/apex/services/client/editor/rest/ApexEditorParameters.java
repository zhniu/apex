...
public class ApexEditorParameters {
    ...
    private static final String[] DEFAULT_PACKAGES = new String[] {"com.ericsson.apex.services.client.editor.rest"};
    ...
    public String toString() {
        ...
        ret.append(this.getClass().getSimpleName()).append(": URI=").append(this.getBaseURI()).append(", TTL=").append(this.getTimeToLive()).append("sec");
        return ret.toString();
    }
