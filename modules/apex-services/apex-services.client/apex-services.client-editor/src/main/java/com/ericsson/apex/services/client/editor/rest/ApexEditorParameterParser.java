...
public class ApexEditorParameterParser {
    ...
    public ApexEditorParameters parse(final String[] args) {
        ...
        if (commandLine.getArgs().length > 0) {
            throw new ApexEditorParameterException("too many command line arguments specified : " + Arrays.toString(remainingArgs));
        }
    ...
    public String getHelp(final String mainClassName) {
        ...
        helpFormatter.printHelp(stringPrintWriter, COMMAND_HELP_MAX_LINE_WIDTH, mainClassName + " [options...] ", null, options, 0, 1, "");
