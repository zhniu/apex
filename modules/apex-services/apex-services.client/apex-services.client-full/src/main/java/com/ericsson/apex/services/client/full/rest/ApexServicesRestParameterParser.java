...
public class ApexServicesRestParameterParser {
	...
	public ApexServicesRestParameters parse(final String[] args) {
		...
		try {
			...
			throw new ApexServicesRestParameterException("invalid command line arguments specified : " + e.getMessage());
		}
		...
		if (commandLine.getArgs().length > 0) {
			throw new ApexServicesRestParameterException("too many command line arguments specified : " + Arrays.toString(remainingArgs));
		}
		...
		try {
			...
			throw new ApexServicesRestParameterException("error parsing argument \"time-to-live\" :" + e.getMessage(), e);
		}
