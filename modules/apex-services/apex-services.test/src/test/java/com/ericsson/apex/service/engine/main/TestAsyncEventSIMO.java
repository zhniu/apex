...
public class TestAsyncEventSIMO {

    @Test
    public void testJsonFileAsyncSIMO() throws MessagingException, ApexException, IOException {
        String[] args = {
                "-c",
        ...
        testFileEvents(args, outFilePaths, 48656);
    }
