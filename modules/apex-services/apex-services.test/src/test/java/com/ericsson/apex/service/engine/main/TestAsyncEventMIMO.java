...
public class TestAsyncEventMIMO {
    ...
    private void testFileEvents(final String[] args, final String[] outFilePaths, final long expectedFileSize) throws MessagingException, ApexException, IOException {
        ...
        assertEquals(expectedFileSize, outFile0Size);
        assertEquals(expectedFileSize, outFile1Size);
        assertEquals(expectedFileSize, outFile2Size);
    }
}
