...
public class TestAsyncEventMISO {

    @Test
    public void testJsonFileAsyncMISO() throws MessagingException, ApexException, IOException {
        String[] args = {"-c", "src/test/resources/parameters/File2FileJsonEventAsyncMISO.json"};

        testFileEvents(args, "src/test/resources/events/EventsOutSingle.json", 48656*3);
    }
