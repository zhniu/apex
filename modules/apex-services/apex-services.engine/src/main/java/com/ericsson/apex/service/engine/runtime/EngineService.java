...
/**
 * The administration interface for Apex engine users. Apex engine implementations expose this interface and external users use it to manage Apex engines.
 *
...
public interface EngineService {
    ...
    /**
     * This method updates the Apex model on Apex execution engines using a string representation of the model.
     *
     ...
     * @param forceFlag if true, model updates will be executed even on incompatible models (different model names) and versions (different model version)
     ...
     * <p>
     * Note: an engine can be both not stopped and not started, for example, when it is starting or stopping
     *
