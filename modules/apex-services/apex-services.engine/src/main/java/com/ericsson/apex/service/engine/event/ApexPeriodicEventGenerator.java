...
/**
 * This class is used to generate periodic events into an Apex engine service. It is used to trigger policies that perform housekeeping operations.
 *
 * @author eeilfn
 */
public class ApexPeriodicEventGenerator extends TimerTask {
    ...
    /** The field name in the periodic event for the time at which the first periodic event will occur. */
    public static final String PERIODIC_FIRST_TIME = "PERIODIC_FIRST_TIME";

    /** The field name in the periodic event for the time at which the last periodic event will occur. */
    ...
    /**
     * The field name in the periodic event for the number of occurrences of this event that have been sent to date, this is a sequence number for the periodic
     * event.
     */
     ...
     *
     * @param engineServiceEventInterface the engine service event interface on which to send periodic events
     * @param period The period in milliseconds between events
     */
    public ApexPeriodicEventGenerator(final EngineServiceEventInterface engineServiceEventInterface, final long period) {
    ...
    public void run() {
        ...
        try {
            final ApexEvent periodicEvent = new ApexEvent(PERIODIC_EVENT_NAME, PERIODIC_EVENT_VERSION, PERIODIC_EVENT_NAMESPACE, PERIODIC_EVENT_SOURCE,
                    PERIODIC_EVENT_TARGET);
    ...
    public String toString() {
        return "ApexPeriodicEventGenerator [period=" + period + ", firstEventTime=" + firstEventTime + ", lastEventTime=" + lastEventTime + ", eventCount="
                + eventCount + "]";
    }
}
