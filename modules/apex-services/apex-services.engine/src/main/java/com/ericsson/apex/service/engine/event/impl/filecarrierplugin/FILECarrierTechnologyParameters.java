...
package com.ericsson.apex.service.engine.event.impl.filecarrierplugin;
 ...
 * <li>standardIO: If this flag is set to true, then standard input is used to read events in or standard output is used to write events and the fileName
...
public class FILECarrierTechnologyParameters extends CarrierTechnologyParameters {
    ...
    public String validate() {
        ...
        if (!standardIO && !standardError && (fileName == null || fileName.trim().length() == 0)) {
            errorMessageBuilder.append("  fileName not specified or is blank or null, it must be specified as a valid file location\n");
        }
