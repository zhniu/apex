...
public class CGCliEditor {
    ...
    public static final String STG_FILE = "com/ericsson/apex/auth/clicodegen/cli-editor.stg";
     ...
     */
    public void addModelParams(final String name, final String version,
     ...
     */
    public void addSchemaDeclaration(final String name, final String version,
            final String uuid, final String description, final String flavour, final String schema) {
     ...
     */
    public void addContextAlbumDeclaration(final String name, final String version,
            final String uuid, final String description, final String scope, final boolean writable,
            final String schemaName, final String schemaVersion) {
     ...
     */
    public ST createEventFieldDefinition(final String eventName, final String version,
            final String fieldName, final String fieldSchema, final String fieldSchemaVersion, final boolean optional) {
     ...
     */
    public ST createTaskDefLogic(final String taskName, final String version,
            final String flavour, final String logic) {
     ...
     */
    public void addEventDeclaration(final String name, final String version,
            final String uuid, final String description, final String nameSpace,
            final String source, final String target, final List<ST> fields) {
     ...
     */
    public void addTaskDeclaration(final String name, final String version,
            final String uuid, final String description, final List<ST> infields,
            final List<ST> outfields, final ST logic,
            final List<ST> parameters, final List<ST> contextRefs) {
     ...
     */
    public void addPolicyDefinition(final String name, final String version,
            final String uuid, final String description, final String template,
            final String firstState, final List<ST> states) {
     ...
     */
    public ST createTaskDefinitionInfields(final String taskName, final String version,
            final String fieldName, final String fieldSchema, final String fieldSchemaVersion) {
     ...
     */
    public ST createTaskDefinitionOutfields(final String taskName, final String version,
            final String fieldName, final String fieldSchema, final String fieldSchemaVersion) {
     ...
     */
    public ST createTaskDefinitionParameters(final String name, final String version,
     ...
     */
    public ST createTaskDefinitionContextRef(final String name, final String version,
     ...
     */
    public ST createPolicyStateTask(final String policyName, final String version,
            final String stateName, final String taskLocalName, final String taskName, final String taskVersion,
     ...
     */
    public ST createPolicyStateOutput(final String policyName, final String version,
            final String stateName, final String outputName, final String eventName, final String eventVersion,
     ...
     */
    public ST createPolicyStateDef(final String policyName, final String version,
            final String stateName, final String triggerName, final String triggerVersion,
            final String defaultTask, final String defaultTaskVersion, final List<ST> outputs,
            final List<ST> tasks, final List<ST> tsLogic,
     ...
     */
    public ST createPolicyStateDefTaskSelLogic(final String name, final String version,
     ...
     */
    public ST createPolicyStateDefFinalizerLogic(final String name, final String version,
     ...
     */
    public ST createPolicyStateDefContextRef(final String name, final String version,
            final String stateName, final String albumName, final String albumVersion) {
