...
public class CLIParameters {
	...
	private void validateWritableDirectory(final String directoryTag, final String directoryName) {
		...
		if (theDirectory.exists()) {
			if (!theDirectory.isDirectory()) {
				throw new CLIException("directory " + directoryName + " of type " + directoryTag + " is not a directory");
			}
			if (!theDirectory.canWrite()) {
				throw new CLIException("directory " + directoryName + " of type " + directoryTag + " cannot be written");
			}
		}
	}
	...
	/**
	 * Sets the file name of the file containing properties that are used for command default values.
	 *
	...
	/**
	 * Sets the name of the file containing the Apex model that will be used to initialize the Apex model in the CLI editor.
	 *
	 * @param inputModelFileName the name of the file containing the Apex model that will be used to initialize the Apex model in the CLI editor
	 */
	...
	/**
	 * Check if the name of the file containing the Apex model that will be used to initialize the Apex model in the CLI editor is set.
	 *
	 * @return true, if the name of the file containing the Apex model that will be used to initialize the Apex model in the CLI editor is set
	 */
	 ...
	 *
	 * @return the name of the file that the Apex CLI editor will save the Apex model to when it exits
	 */
	 ...
	 *
	 * @param outputModelFileName the name of the file that the Apex CLI editor will save the Apex model to when it exits
	 */
	 ...
	 *
	 * @param logFileName the name of the file to which the Apex CLI editor will log commands and responses
	 */
	 ...
	 *
	 * @return true, if checks if the Apex CLI editor is set to suppress output of its Apex model on exit
	 */
	 ...
	 *
	 * @param suppressModelOutput true, if the Apex CLI editor should suppress output of its Apex model on exit
	 */
	...
	public String toString() {
		return "CLIParameters [helpSet=" + helpSet + ", metadataFileName=" + metadataFileName + ", apexPropertiesFileName=" + apexPropertiesFileName
				+ ", commandFileName=" + commandFileName + ", inputModelFileName=" + inputModelFileName + ", outputModelFileName=" + outputModelFileName
				+ ", logFileName=" + logFileName + ", echo=" + echo + ", suppressLog=" + suppressLog + ", suppressModelOutput=" + suppressModelOutput + "]";
	}
}
