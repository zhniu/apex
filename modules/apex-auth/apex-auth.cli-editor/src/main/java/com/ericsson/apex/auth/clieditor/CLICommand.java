...
/**
 * This class represents a single Apex CLI command that is issued to the Apex Editor Java API {@link com.ericsson.apex.model.modelapi.ApexEditorAPI}.
 *
...
public class CLICommand implements Comparable<CLICommand> {
    ...
    public String getAPIClassName() {
        ...
        if (lastDotPos == -1) {
            throw new CLIException("invalid API method name specified on command \"" + name + "\", class name not found: " + apiMethod);
        }
    ...
    public String toString() {
        return "CLICommand [name=" + name + ",keywordlist=" + keywordlist + ", argumentList=" + argumentList + ", apiMethod=" + apiMethod + ", systemCommand="
                + systemCommand + ", description=" + description + "]";
    }
