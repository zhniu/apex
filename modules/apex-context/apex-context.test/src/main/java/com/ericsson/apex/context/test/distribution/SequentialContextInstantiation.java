    ...
    public void testSequentialContextInstantiation() throws ContextException {
       ...
       // @formatter:on
        ...
        try {
            ...
            final ContextAlbum dateAlbum = contextDistributor.createContextAlbum(new AxArtifactKey("DateContextAlbum", "0.0.1"));
            ...
            try {
                ...
                assert (e.getMessage().contains(
                        "class \"com.ericsson.apex.context.test.concepts.TestContextItem009\" not compatible with class \"com.ericsson.apex.context.test.concepts.TestContextItem00A\""));
            }
            ...
            final ContextAlbum dateAlbum1 = contextDistributor.createContextAlbum(new AxArtifactKey("DateContextAlbum", "0.0.1"));
            ...
            try {
                ...
                assert (e.getMessage().endsWith("not compatible with class \"com.ericsson.apex.context.test.concepts.TestContextItem00A\""));
            }
            ...
            final ContextAlbum dateAlbumCopy = contextDistributor.createContextAlbum(new AxArtifactKey("DateContextAlbum", "0.0.1"));
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"DateContextAlbum:0.0.1\" null keys are illegal on keys for get()"));
            }
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"DateContextAlbum:0.0.1\" null keys are illegal on keys for put()"));
            }
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"DateContextAlbum:0.0.1\" null values are illegal on key \"ItemNull\" for put()"));
            }
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"DateContextAlbum:0.0.1\" null values are illegal on key \"TestAA\" for put()"));
            }
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"DateContextAlbum:0.0.1\" null values are illegal on key \"TestAB\" for put()"));
            }
            assert (dateAlbum.size() == 8);
