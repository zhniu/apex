...
import com.ericsson.apex.context.test.concepts.TestContextItem000;
import com.ericsson.apex.context.test.concepts.TestContextItem001;
import com.ericsson.apex.context.test.concepts.TestContextItem002;
import com.ericsson.apex.context.test.concepts.TestContextItem003;
import com.ericsson.apex.context.test.concepts.TestContextItem004;
import com.ericsson.apex.context.test.concepts.TestContextItem005;
import com.ericsson.apex.context.test.concepts.TestContextItem006;
import com.ericsson.apex.context.test.concepts.TestContextItem007;
import com.ericsson.apex.context.test.concepts.TestContextItem008;
import com.ericsson.apex.context.test.concepts.TestContextItem009;
import com.ericsson.apex.context.test.concepts.TestContextItem00A;
import com.ericsson.apex.context.test.concepts.TestContextItem00B;
import com.ericsson.apex.context.test.concepts.TestContextItem00C;
import com.ericsson.apex.context.test.concepts.TestExternalContextItem;
import com.ericsson.apex.context.test.concepts.TestGlobalContextItem;
import com.ericsson.apex.context.test.concepts.TestPolicyContextItem;
...
public class ContextInstantiation {
    ...
    public void testContextInstantiation() throws ContextException {
        ...
        try {
            ...
            final ContextAlbum policyContextAlbum = contextDistributor.createContextAlbum(new AxArtifactKey("PolicyContextAlbum", "0.0.1"));
            ...
            final TestContextItem006 testPolicyContextItem000 = new TestContextItem006("This is a policy context string");
            ...
            try {
                ...
                assert (e.getMessage()
                        .equals("Failed to set context value for key \"TestPolicyContextItem000\" in album \"PolicyContextAlbum:0.0.1\": "
                                ...
                                + "of class \"com.ericsson.apex.context.test.concepts.TestContextItem006\""
                                + " not compatible with class \"com.ericsson.apex.context.test.concepts.TestPolicyContextItem\""));
            }
            ...
            try {
                ...
                assert (e.getMessage()
                        .equals("Failed to set context value for key \"TestPolicyContextItem001\" in album \"PolicyContextAlbum:0.0.1\": "
                                ...
                                + "of class \"com.ericsson.apex.context.test.concepts.TestContextItem003\""
                                + " not compatible with class \"com.ericsson.apex.context.test.concepts.TestPolicyContextItem\""));
            }
            ...
            assert (((TestPolicyContextItem) policyContextAlbum.get("TestPolicyContextItem")).getTestPolicyContextItem000().getStringValue()
                    .equals("This is a policy context string"));
            assert (((TestPolicyContextItem) policyContextAlbum.get("TestPolicyContextItem")).getTestPolicyContextItem001()
                    .getLongValue() == 0xFFFFFFFFFFFFFFFFL);
            assert (((TestPolicyContextItem) policyContextAlbum.get("TestPolicyContextItem")).getTestPolicyContextItem002().getDoubleValue() == Math.PI);
            assert (((TestPolicyContextItem) policyContextAlbum.get("TestPolicyContextItem")).getTestPolicyContextItem003().getFlag());
            assert (((TestPolicyContextItem) policyContextAlbum.get("TestPolicyContextItem")).getTestPolicyContextItem004().getLongValue() == testDate
                    .getTime());
            assert (((TestPolicyContextItem) policyContextAlbum.get("TestPolicyContextItem")).getTestPolicyContextItem005().getMapValue().equals(testHashMap));
            ...
            final TestContextItem006 testGlobalContextItem006 = new TestContextItem006("This is a global context string");
            ...
            try {
                ...
                assert (e.getMessage().equals("active context albums found in distributor, clear the distributor before registering models"));
            }

            contextDistributor.registerModel(globalContextModel);

            final ContextAlbum globalContextAlbum = contextDistributor.createContextAlbum(new AxArtifactKey("GlobalContextAlbum", "0.0.1"));
            ...
            assert (!((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem000().getFlag());
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem001().getByteValue() == (byte) 0xFF);
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem002().getIntValue() == 0xFFFFFFFF);
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem003().getLongValue() == 0xFFFFFFFFFFFFFFFFL);
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem004().getFloatValue() == testFloat);
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem005().getDoubleValue() == Math.PI);
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem006().getStringValue()
                    .equals("This is a global context string"));
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem007().getLongValue() == testDate.getTime());
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem008().getDateValue().equals(testDate));
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem009().getDateValue().getTime() == tci9
                    .getDateValue().getTime());
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem00A().getDateValue().getTime() == tciA
                    .getDateValue().getTime());
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem00B().getSetValue().equals(testTreeSet));
            assert (((TestGlobalContextItem) globalContextAlbum.get("globalContext")).getTestGlobalContextItem00C().getMapValue().equals(testHashMap));
            ...
            final TestContextItem006 testExternalContextItem006 = new TestContextItem006("This is an external context string");
            ...
            final ContextAlbum externalContextAlbum = contextDistributor.createContextAlbum(new AxArtifactKey("ExternalContextAlbum", "0.0.1"));
            ...
            assert (!((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem000().getFlag());
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem001().getByteValue() == (byte) 0xFF);
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem002().getIntValue() == 0xFFFFFFFF);
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem003()
                    .getLongValue() == 0xFFFFFFFFFFFFFFFFL);
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem004().getFloatValue() == testFloat);
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem005().getDoubleValue() == Math.PI);
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem006().getStringValue()
                    .equals("This is an external context string"));
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem007().getLongValue() == testDate
                    .getTime());
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem008().getDateValue().equals(testDate));
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem009().getDateValue().getTime() == tci9A
                    .getDateValue().getTime());
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem00A().getDateValue().getTime() == tciAA
                    .getDateValue().getTime());
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem00B().getSetValue().equals(testTreeSet));
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem00C().getMapValue().equals(testHashMap));
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"ExternalContextAlbum:0.0.1\" clear() not allowed on read only albums"));
            }
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"ExternalContextAlbum:0.0.1\" null keys are illegal on keys for get()"));
            }
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"ExternalContextAlbum:0.0.1\" null keys are illegal on keys for put()"));
            }
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"ExternalContextAlbum:0.0.1\" null values are illegal on key \"TestExternalContextItem00A\" for put()"));
            }
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem00A().equals(tciAA));
            ...
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem002().getIntValue() == 2000);
            assert (externalContextAlbum.put("externalContext", externalContext).equals(externalContextOther));
            assert (((TestExternalContextItem) externalContextAlbum.get("externalContext")).getTestExternalContextItem002().getIntValue() == -1);
            ...
            try {
                ...
                assert (e.getMessage().equals("album \"ExternalContextAlbum:0.0.1\" null values are illegal on key \"TestExternalContextItemFFF\" for put()"));
            }
            assert (externalContextAlbum.size() == 1);
